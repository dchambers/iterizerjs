...
describe('range()', function() {
	...
	it('throws a nice error if the range arguments are not numbers', function() {
		(function() {
			range('1', '10').next();
		}).should.throw("'start' must be a number");

		(function() {
			range(1, '10').next();
		}).should.throw("'stop' must be a number");
	});
