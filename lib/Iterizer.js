...
Iterizer.prototype.installMethods = function() {
	Object.defineProperty(String.prototype, 'chars', {enumerable: false, configurable: true, value: function*() {
		if(this.length > 0) {
			// TODO: make all of these functions available as named functions so the installMethods() function (and others) works even if installGlobals() hasn't been invoked
